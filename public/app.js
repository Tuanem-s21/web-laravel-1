...
const staffs = document.querySelectorAll(".staff-card");
...
staffs.forEach((staff) => {
  staff.addEventListener("click", () => {
    document.querySelector(".selectedd").classList.remove("selectedd");
    staff.classList.add("selectedd");
    const staffName = staff.querySelector("b");
    obj.staff = staffName;
  });
});
