...
<div class="wrapper">
    <div class="content-wrapper">
        <section class="container-fluid">
            ...
            <form class="px-5 py-5" action="{{ route('admin.staff.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <table>
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingInput" placeholder="Phone" name="phone" value="{{ old('phone') }}">
